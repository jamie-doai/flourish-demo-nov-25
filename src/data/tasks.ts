...
export const tasks: Task[] = [
  ...
  { 
    ...
    species: "Coprosma", 
    action: "Pot up seedlings",
    title: "Pot up Coprosma seedlings", 
    location: "ShadeHouse A", 
    due: "Tomorrow", 
    dueDate: "2025-01-24",
    status: "upcoming", 
