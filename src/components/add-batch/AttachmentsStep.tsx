      ...
      <div className="space-y-6">
        <div className="space-y-4">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <Card className="border border-dashed cursor-pointer hover:border-primary hover:bg-primary/5 transition-all">
          ...
          <Card className="bg-muted/50">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="w-16 h-16 bg-white rounded border border-primary/20 flex items-center justify-center">
